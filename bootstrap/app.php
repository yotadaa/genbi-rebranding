...
$adminPageController = new AdminPageController($renderer, $viewRenderer, $newsModel, $teamModel, $prestasiModel, $featureModel, $siteSettings, $presensiEventModel, $presensiSubmissionModel);
