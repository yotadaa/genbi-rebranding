...
<head>
    ...
    <title>Dashboard Bendahara Komsat UNJA - GenBI Jambi</title>
    <!-- Fonts -->
...
<body class="text-slate-800 antialiased selection:bg-blue-200 selection:text-blue-900 flex h-screen overflow-hidden">
    ...
    <aside class="w-64 bg-white border-r border-slate-200 flex flex-col hidden md:flex transition-all duration-300 relative z-20">
        ...
        <nav class="flex-1 px-4 space-y-1.5 mt-2 overflow-y-auto">
            ...
            <a href="/keuangan/bendahara/unja/dashboard" class="flex items-center gap-3 px-3 py-2.5 bg-orange-50 text-orange-700 rounded-xl font-medium transition-colors">
    ...
    <div class="flex-1 flex flex-col relative overflow-hidden bg-slate-50">
        ...
        <main class="flex-1 overflow-y-auto p-6 md:p-8">
            <div class="max-w-6xl mx-auto space-y-6">
                ...
                <!-- Welcome Banner -->
                <div class="bg-gradient-to-r from-orange-500 to-red-600 rounded-2xl p-6 sm:p-8 text-white shadow-lg shadow-orange-500/20 relative overflow-hidden">
                    <div class="relative z-10">
                        <h2 class="text-2xl sm:text-3xl font-bold mb-2">Selamat datang, Bendahara KOMSAT UNJA! 👋</h2>
                        <p class="text-orange-50 max-w-xl">Pantau dan kelola pencatatan keuangan GenBI Komisariat Universitas Jambi (UNJA) secara mandiri dan akurat.</p>
                    </div>
                    <!-- Decorative shapes -->
                    <div class="absolute top-0 right-0 -mr-16 -mt-16 w-64 h-64 rounded-full bg-white/10 blur-3xl"></div>
                    <div class="absolute bottom-0 right-32 -mb-16 w-48 h-48 rounded-full bg-red-700/30 blur-2xl"></div>
                </div>
