...
$normalClass = 'border-slate-200/60 focus:bg-white focus:border-sky-500 focus:ring-sky-500 bg-slate-50/50';
?>
...
<div class="max-w-4xl mx-auto pb-12">
    ...
    <div class="bg-white rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-slate-100/60 overflow-hidden">
        ...
        <form action="/keuangan/bendahara/uin/profil" method="POST">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                    ...
                    <div>
                        ...
                        <select id="universitas" name="universitas" class="w-full px-5 py-3.5 border <?= $hasError('universitas') ? $errorClass : $normalClass ?> rounded-xl text-[14px] outline-none transition-all focus:ring-2 cursor-pointer">
                            ...
                            <option value="UIN" <?= $val('universitas') === 'UIN' ? 'selected' : '' ?>>Universitas Jambi (UNJA)</option>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="text" id="tempat" value="Komsat UIN" disabled
                        ...
                        <p class="mt-2 text-[12px] font-medium text-slate-500">Nilai ini tidak dapat diubah karena terikat dengan hak akses Anda sebagai Bendahara Komsat UIN.</p>
                    </div>
                </div>

                <div class="pt-8 mt-8 border-t border-slate-100 flex justify-end gap-3">
                    <button type="submit" class="inline-flex items-center gap-2 px-8 py-3.5 bg-sky-500 hover:bg-sky-600 text-white text-[13px] font-bold rounded-xl shadow-lg shadow-sky-500/20 transition-all focus:ring-4 focus:ring-sky-500/30">
