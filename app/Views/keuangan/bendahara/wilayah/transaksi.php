...
<div class="max-w-7xl mx-auto">
    ...
    <div class="mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <a href="/keuangan/bendahara/wilayah/transaksi/create" id="btn-add-trx" class="inline-flex items-center justify-center px-4 py-2.5 bg-blue-600 text-white rounded-xl text-sm font-semibold hover:bg-blue-700 transition-colors shadow-sm shadow-blue-200">
