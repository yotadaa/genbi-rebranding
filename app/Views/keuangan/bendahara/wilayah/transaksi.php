...
/** @var array $dummyData */
/** @var callable $e */
$categories = ['BPI Wilayah', 'Tim IT dan Website', 'Tim Media Wilayah'];
?>
<div class="max-w-7xl mx-auto">
    ...
    <div class="mb-10 md:mb-14 flex flex-col sm:flex-row sm:items-start sm:justify-between gap-6">
        <div>
            ...
            <h1 class="text-4xl md:text-[2.75rem] font-serif-title font-medium text-slate-900 tracking-tight leading-tight">Transaksi Wilayah.</h1>
            <p class="text-[15px] text-slate-500 mt-4 max-w-2xl leading-relaxed">Kelola seluruh catatan arus kas GenBI Provinsi Jambi. Tambah, perbarui, atau pantau detail setiap transaksi.</p>
        </div>
        <a href="/keuangan/bendahara/wilayah/transaksi/create" id="btn-add-trx" class="inline-flex items-center justify-center px-6 py-3 bg-[#3b5998] text-white rounded-xl text-[13px] font-semibold hover:bg-blue-800 hover:shadow-lg transition-all shadow-md group mt-2">
    ...
    <div class="bg-white p-6 md:p-8 rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-slate-100/60 mb-8 flex flex-col md:flex-row gap-6 items-center justify-between">
        <div class="flex flex-wrap gap-2 w-full md:w-auto" id="filter-container">
            <button class="category-btn px-5 py-2.5 rounded-xl text-[13px] font-semibold transition-all bg-[#3b5998] text-white shadow-md" data-cat="Semua">Semua Alokasi</button>
