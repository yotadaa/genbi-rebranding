...
<div class="max-w-3xl mx-auto pb-12">
    ...
    <div class="mb-10 md:mb-14 flex flex-col sm:flex-row sm:items-start sm:justify-between gap-6">
        <div>
            ...
            <p class="text-[15px] text-slate-500 mt-4 max-w-2xl leading-relaxed">Isi formulir di bawah ini dengan lengkap dan benar.</p>
        </div>
        <a href="/keuangan/bendahara/wilayah/kegiatan" class="inline-flex items-center justify-center px-6 py-3 bg-white border border-slate-200/60 text-slate-700 rounded-xl text-[13px] font-semibold hover:bg-slate-50 hover:shadow-md transition-all shadow-sm mt-2">
            Kembali
        </a>
    </div>
        ...
        <form action="<?= htmlspecialchars($actionUrl) ?>" method="POST">
            ...
            <div class="p-8 md:p-10 space-y-8">
                ...
                <div class="sm:col-span-2">
                    ...
                    <input type="text" id="nama_kegiatan" name="nama_kegiatan" value="<?= $val('nama_kegiatan') ?>" class="w-full px-5 py-3.5 bg-slate-50 border <?= $hasError('nama_kegiatan') ? $errorClass : $normalClass ?> rounded-xl outline-none transition-all text-[13px] placeholder-slate-400" placeholder="Contoh: Rapat Kerja Wilayah">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <!-- Penyelenggara -->
                    <div>
                        <label for="divisi" class="block text-[11px] font-bold text-slate-500 uppercase tracking-widest mb-3">Penyelenggara / Kategori</label>
                        <input type="text" id="divisi" name="divisi" value="<?= $val('divisi') ?>" class="w-full px-5 py-3.5 bg-slate-50 border border-slate-200/60 focus:border-slate-900 focus:ring-2 focus:ring-slate-900 rounded-xl outline-none transition-all text-[13px] placeholder-slate-400" placeholder="Contoh: Pendidikan / Komsat UNJA">
                    </div>
                    ...
                    <div>
                        ...
                        <p class="mt-2 text-[11px] font-medium text-slate-400">Bendahara Wilayah hanya dapat memproses kegiatan tingkat Wilayah.</p>
                    </div>
                </div>
