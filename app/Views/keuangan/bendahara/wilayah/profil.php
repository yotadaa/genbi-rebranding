...
$normalClass = 'border-slate-200/60 focus:bg-white focus:border-slate-900 focus:ring-slate-900 bg-slate-50/50';
?>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                ...
                <div class="md:col-span-2">
                    ...
                    <?php if ($hasError('nama_bendahara')): ?>
                        <p class="mt-2 text-[12px] font-medium text-rose-500 flex items-center gap-1.5"><svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg><?= htmlspecialchars($errors['nama_bendahara']) ?></p>
                    <?php endif; ?>
                </div>
                ...
                <div class="md:col-span-2">
                    ...
                    <?php if ($hasError('email')): ?>
                        <p class="mt-2 text-[12px] font-medium text-rose-500 flex items-center gap-1.5"><svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg><?= htmlspecialchars($errors['email']) ?></p>
                    <?php endif; ?>
                </div>
                ...
                <div>
                    ...
                    <?php if ($hasError('tahun_periode_awal')): ?>
                        <p class="mt-2 text-[12px] font-medium text-rose-500 flex items-center gap-1.5"><svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg><?= htmlspecialchars($errors['tahun_periode_awal']) ?></p>
                    <?php endif; ?>
                </div>
                ...
                <div>
                    ...
                    <?php if ($hasError('tahun_periode_akhir')): ?>
                        <p class="mt-2 text-[12px] font-medium text-rose-500 flex items-center gap-1.5"><svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg><?= htmlspecialchars($errors['tahun_periode_akhir']) ?></p>
                    <?php endif; ?>
                </div>
                ...
                <div>
                    ...
                    <?php if ($hasError('jenis_kelamin')): ?>
                        <p class="mt-2 text-[12px] font-medium text-rose-500 flex items-center gap-1.5"><svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg><?= htmlspecialchars($errors['jenis_kelamin']) ?></p>
                    <?php endif; ?>
                </div>
                ...
                <div>
                    ...
                    <?php if ($hasError('universitas')): ?>
                        <p class="mt-2 text-[12px] font-medium text-rose-500 flex items-center gap-1.5"><svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg><?= htmlspecialchars($errors['universitas']) ?></p>
                    <?php endif; ?>
                </div>
                ...
                <div>
                    ...
                    <?php if ($hasError('program_studi')): ?>
                        <p class="mt-2 text-[12px] font-medium text-rose-500 flex items-center gap-1.5"><svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg><?= htmlspecialchars($errors['program_studi']) ?></p>
                    <?php endif; ?>
                </div>
                ...
                <div>
                    ...
                    <?php if ($hasError('semester_studi')): ?>
                        <p class="mt-2 text-[12px] font-medium text-rose-500 flex items-center gap-1.5"><svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg><?= htmlspecialchars($errors['semester_studi']) ?></p>
                    <?php endif; ?>
                </div>
                ...
                <div class="md:col-span-2">
                    ...
                    <p class="mt-2 text-[12px] font-medium text-slate-500">Nilai ini tidak dapat diubah karena terikat dengan hak akses Anda sebagai Bendahara Wilayah.</p>
                </div>
            </div>

            <div class="pt-8 mt-8 border-t border-slate-100 flex justify-end gap-3">
                <button type="submit" class="inline-flex items-center gap-2 px-8 py-3.5 bg-[#3b5998] hover:bg-[#2d4373] text-white text-[13px] font-bold rounded-xl shadow-lg shadow-[#3b5998]/20 transition-all focus:ring-4 focus:ring-[#3b5998]/30">
