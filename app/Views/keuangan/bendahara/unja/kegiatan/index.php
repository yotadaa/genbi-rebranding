...
<div class="max-w-7xl mx-auto pb-12">
    ...
    <div class="mb-10 flex flex-col md:flex-row md:items-end justify-between gap-6">
        <div>
            ...
            <p class="text-[15px] text-slate-500 mt-4 max-w-2xl leading-relaxed">Kelola data kegiatan keuangan tingkat Komsat UNJA GenBI Provinsi Jambi.</p>
        </div>
        <div class="flex items-center gap-3">
            <a href="/keuangan/bendahara/unja/kegiatan/tambah" class="group inline-flex items-center justify-center gap-2.5 px-6 py-3.5 bg-[#f97316] text-white rounded-xl text-[13px] font-semibold hover:bg-[#ea580c] hover:shadow-lg hover:shadow-[#f97316]/30 transition-all shadow-md">
                    ...
                    <?php else: ?>
                        ...
                        <tr class="hover:bg-slate-50/50 transition-colors group">
                            ...
                            <td class="px-6 md:px-8 py-5 whitespace-nowrap">
                                <span class="inline-flex items-center px-3 py-1 rounded-lg text-[11px] font-semibold bg-orange-50 text-orange-700 border border-orange-100/50">
                            ...
                            <td class="px-6 md:px-8 py-5 whitespace-nowrap text-center">
                                <div class="flex items-center justify-center gap-3 opacity-80 group-hover:opacity-100 transition-opacity">
                                    <a href="/keuangan/bendahara/unja/kegiatan/edit/<?= $row['id'] ?>" class="p-2 text-slate-400 hover:text-amber-500 hover:bg-amber-50 rounded-xl transition-all" title="Edit Data">
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z"></path></svg>
                                    </a>
                                    <form action="/keuangan/bendahara/unja/kegiatan/hapus/<?= $row['id'] ?>" method="POST" class="inline-block m-0">
