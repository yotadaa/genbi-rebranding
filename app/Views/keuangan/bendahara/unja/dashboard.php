...
<div class="max-w-7xl mx-auto">
    ...
    <div class="mb-10 md:mb-14">
        <div class="text-[10px] md:text-xs font-bold text-slate-500 uppercase tracking-[0.2em] mb-4">BENDAHARA KOMSAT UNJA</div>
        <h1 class="text-4xl md:text-[2.75rem] font-serif-title font-medium text-slate-900 tracking-tight leading-tight">Dashboard keuangan Komsat UNJA.</h1>
        <p class="text-[15px] text-slate-500 mt-4 max-w-2xl leading-relaxed">Ringkasan arus kas keuangan Komsat UNJA saat ini. Pantau seluruh transaksi masuk dan keluar dari satu tempat tanpa hambatan.</p>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <div class="bg-white rounded-3xl p-8 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-slate-100/60 hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)] transition-all flex flex-col">
            ...
            <a href="/keuangan/bendahara/unja/transaksi?type=in" class="mt-auto text-[13px] font-semibold text-orange-600 hover:text-orange-800 inline-flex items-center group">Buka Transaksi Masuk <span class="ml-1.5 group-hover:translate-x-1 transition-transform">&rarr;</span></a>
        </div>
        ...
        <div class="bg-white rounded-3xl p-8 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-slate-100/60 hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)] transition-all flex flex-col">
            ...
            <a href="/keuangan/bendahara/unja/transaksi?type=out" class="mt-auto text-[13px] font-semibold text-orange-600 hover:text-orange-800 inline-flex items-center group">Buka Transaksi Keluar <span class="ml-1.5 group-hover:translate-x-1 transition-transform">&rarr;</span></a>
        </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
        ...
        <div class="bg-white rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-slate-100/60 flex flex-col overflow-hidden p-8">
            <div class="mb-6 flex items-center justify-between">
                ...
                <a href="/keuangan/bendahara/unja/transaksi" class="text-[13px] font-semibold text-orange-600 hover:text-orange-800 group">Lihat Semua <span class="inline-block ml-1 group-hover:translate-x-1 transition-transform">&rarr;</span></a>
            </div>
