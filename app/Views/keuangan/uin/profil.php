...
<body class="text-slate-800 antialiased selection:bg-blue-200 selection:text-blue-900 flex h-screen overflow-hidden">
    ...
    <aside class="w-64 bg-white border-r border-slate-200 flex flex-col hidden md:flex transition-all duration-300 relative z-20">
        ...
        <!-- Role Badge -->
        <div class="px-6 py-4">
            <span class="inline-flex items-center gap-1.5 py-1.5 px-3 rounded-full text-xs font-semibold bg-cyan-50 text-cyan-700 border border-cyan-100 w-full justify-center">
                <span class="w-1.5 h-1.5 rounded-full bg-cyan-500 animate-pulse"></span>
                Bendahara Komsat UIN
            </span>
        </div>
        ...
        <nav class="flex-1 px-4 space-y-1.5 mt-2 overflow-y-auto">
            ...
            <a href="/keuangan/bendahara/uin/dashboard" class="flex items-center gap-3 px-3 py-2.5 <?= $isDashboard ? 'bg-cyan-50 text-cyan-700' : 'text-slate-600 hover:bg-slate-50 hover:text-slate-900' ?> rounded-xl font-medium transition-colors">
                <svg class="w-5 h-5 <?= $isDashboard ? 'text-cyan-600' : 'text-slate-400' ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <a href="/keuangan/bendahara/uin/profil" class="flex items-center gap-3 px-3 py-2.5 <?= $isProfil ? 'bg-cyan-50 text-cyan-700' : 'text-slate-600 hover:bg-slate-50 hover:text-slate-900' ?> rounded-xl font-medium transition-colors">
                <svg class="w-5 h-5 <?= $isProfil ? 'text-cyan-600' : 'text-slate-400' ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    ...
    <aside id="mobile-sidebar" class="fixed inset-y-0 left-0 w-72 bg-white border-r border-slate-200 flex flex-col z-50 closed md:hidden">
        ...
        <nav class="flex-1 px-4 space-y-1.5 mt-2 overflow-y-auto">
            ...
            <a href="/keuangan/bendahara/uin/dashboard" class="flex items-center gap-3 px-3 py-2.5 <?= $isDashboardM ? 'bg-cyan-50 text-cyan-700' : 'text-slate-600 hover:bg-slate-50 hover:text-slate-900' ?> rounded-xl font-medium transition-colors">
                <svg class="w-5 h-5 <?= $isDashboardM ? 'text-cyan-600' : 'text-slate-400' ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"></path>
                </svg>
                Dashboard
            </a>
            ...
            <a href="/keuangan/bendahara/uin/profil" class="flex items-center gap-3 px-3 py-2.5 <?= $isProfilM ? 'bg-cyan-50 text-cyan-700' : 'text-slate-600 hover:bg-slate-50 hover:text-slate-900' ?> rounded-xl font-medium transition-colors">
                <svg class="w-5 h-5 <?= $isProfilM ? 'text-cyan-600' : 'text-slate-400' ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path>
                </svg>
                Profile
            </a>
        ...
        <header class="h-16 bg-white border-b border-slate-200 flex items-center justify-between px-6 z-20 relative">
            ...
            <div class="flex items-center gap-4">
                <div class="text-right hidden sm:block">
                    <p class="text-sm font-semibold text-slate-700 leading-tight">Nama Bendahara UIN</p>
                    <p class="text-xs text-slate-500">Bendahara Komsat UIN</p>
                </div>
                <div class="w-10 h-10 rounded-full bg-cyan-100 border-2 border-white shadow-sm flex items-center justify-center text-cyan-700 font-bold overflow-hidden">
                    UI
                </div>
            </div>
        </header>
