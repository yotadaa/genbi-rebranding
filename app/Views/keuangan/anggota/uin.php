...
$dummyData = [
    ['id' => 1, 'date' => '2026-08-02', 'desc' => 'Uang Kas Masuk', 'category' => 'PSDM (Pengembangan Sumber Daya Manusia)', 'type' => 'in', 'amount' => 1200000],
    ['id' => 2, 'date' => '2026-08-04', 'desc' => 'Kegiatan Bersih Desa', 'category' => 'Divisi Lingkungan Hidup', 'type' => 'out', 'amount' => 600000],
    ['id' => 3, 'date' => '2026-08-06', 'desc' => 'Buku Panduan Anggota', 'category' => 'Divisi Pendidikan dan Kebudayaan', 'type' => 'out', 'amount' => 300000],
    ['id' => 4, 'date' => '2026-08-08', 'desc' => 'Bazaar Mahasiswa', 'category' => 'Divisi Kewirausahaan', 'type' => 'in', 'amount' => 850000],
    ['id' => 5, 'date' => '2026-08-10', 'desc' => 'Cek Kesehatan Gratis', 'category' => 'Divisi Pengabdian Masyarakat', 'type' => 'out', 'amount' => 950000],
    ['id' => 6, 'date' => '2026-08-13', 'desc' => 'Iklan Media Sosial', 'category' => 'Divisi Publikasi dan Sosial', 'type' => 'out', 'amount' => 150000],
    ['id' => 7, 'date' => '2026-08-14', 'desc' => 'Donasi Alumni', 'category' => 'PSDM (Pengembangan Sumber Daya Manusia)', 'type' => 'in', 'amount' => 500000],
];
?>
...
<div class="site-container py-8" data-dashboard="true" data-transactions='<?= htmlspecialchars(json_encode($dummyData), ENT_QUOTES, 'UTF-8') ?>'>
    ...
    <div class="mb-8">
        <h1 class="text-3xl font-bold text-slate-900 tracking-tight">Keuangan KOMSAT UIN</h1>
        <p class="text-slate-500 mt-2">Dashboard pantauan arus kas dan pengeluaran per divisi untuk UIN Sulthan Thaha Saifuddin.</p>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-slate-200 p-6 flex items-center gap-4">
            <div class="w-12 h-12 rounded-full bg-fuchsia-100 text-fuchsia-600 flex items-center justify-center shrink-0">
