...
<section class="mx-auto max-w-7xl">
  <header class="cms-header slide-in">
    ...
    <div class="cms-actions">
      <a href="{{ route('admin.genbiPoin') }}" class="btn btn-secondary">View All</a>
    </div>
  </header>
        ...
        <section class="config-card medium-config-card">
          ...
          <div class="config-field">
            ...
            <div class="presensi-autocomplete" data-genbi-point-member-picker>
              <input class="config-input" id="genbi-point-member-search" value="{{ $memberName }}" placeholder="Cari nama anggota..." autocomplete="off" required>
          ...
          <div class="config-field">
            ...
            <input class="config-input" id="genbi-point-activity-name" value="{{ $activityName }}" maxlength="255" placeholder="Contoh: Fasilitator Edukasi BI" required>
          </div>
          <div class="config-field">
          ...
          <div class="config-field">
            <span>Tanggal</span>
            <input class="config-input" id="genbi-point-date" type="date" value="{{ $activityDate }}">
          </div>
        </section>
