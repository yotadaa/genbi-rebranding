...
<section class="mx-auto max-w-7xl">
  <header class="cms-header slide-in">
    ...
    <div class="cms-actions">
      ...
      @if ($isEdit)
        <a href="{{ route('admin.presensi.show', ['id' => $itemId]) }}" class="btn btn-outline">Detail</a>
      @endif
    </div>
  </header>
      ...
      <div class="editor-config-sidebar prestasi-config-panel">
        <section class="config-card medium-config-card">
          ...
          <div class="config-field">
            ...
            <input class="config-input" id="presensi-event-name" value="{{ $eventName }}" maxlength="255" required>
          </div>
          <div class="config-field">
            <span>Lokasi</span>
            <input class="config-input" id="presensi-location" value="{{ $location }}" maxlength="255" required>
          </div>
          <div class="config-field">
            <span>Status</span>
        ...
        <section class="config-card medium-config-card">
          ...
          <input type="hidden" id="presensi-roles-json" value='@json(array_values($roleOptions))'>
        ...
        <section class="config-card medium-config-card">
          ...
          <input type="hidden" id="presensi-members-json" value='@json(array_values($members))'>
