(function (root, factory) {
  ...
  const ROUTES = {
    ...
    admin: {
      ...
      faq: { clean: '/admin/faq', static: 'admin/faq.html' },
      faqAdd: { clean: '/admin/faq-add', static: 'admin/faq-add.html' },
      faqs: { clean: '/admin/faqs' },
      faqShow: { clean: '/admin/faqs/{id}' },
      faqStore: { clean: '/admin/faqs' },
      faqUpdate: { clean: '/admin/faqs/{id}/update' },
      faqDelete: { clean: '/admin/faqs/{id}/delete' },
      social: { clean: '/admin/social-media', static: 'admin/social-media.html' },
      socialLinks: { clean: '/admin/social-links' },
      socialUpdate: { clean: '/admin/social-links' },
