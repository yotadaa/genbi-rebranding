(function(){"use strict";const{renderShell:n}=window.GenBIApp,{observeFadeUp:s}=window.GenBIUI,{aboutBlocks:i}=window.GenBIData;n("about"),document.body.dataset.ssr!=="true"&&(o(),r()),s();function o(){const e=document.querySelector("#about-content");e.innerHTML=i.map(t=>`
